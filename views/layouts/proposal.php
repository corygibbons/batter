...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en">
    ...
    <head>
        ...
        <!-- CSS -->
        <?php echo asset::css('proposal.css', array('media' => 'all'), NULL, $pdf_mode); ?>
        <?php echo asset::css('plugins/facebox.css', array('media' => 'screen'), NULL, $pdf_mode); ?>
        <?php echo asset::css('plugins/redactor.css', array('media' => 'screen'), NULL, $pdf_mode); ?>
        ...
        <?php if (is_admin()) :?>
        <script src="<?php echo asset::get_src('jquery-ui-sortable.min.js', 'js');?>"></script>
